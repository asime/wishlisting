class Donation < ActiveRecord::Base
  ...
  attr_accessible :charity_id, :wishlist_item_id, :amount, :city, :email, :fname, :lname, :phone, :postal, :processed, :state, :street1, :street2, :credit_card, :exp_month, :exp_year, :processor_message
